...
public class PrecinctPartyRegistrationChangeReport {
	...
	public PrecinctPartyRegistrationChangeReport(String precinct, MainModel model) {
	...
	public String run() throws IOException {
		...
		ChangedPartyModel changeModel = model.getChangedPartyModel(92);
		ArrayList<Voter> precinctVoters = vm.getAll();
		
		StringBuffer sb = new StringBuffer();
		sb.append("Listing all voters that have changed party registration in " + precinctId + " in the past year:\n");
	...
	private String precinctWideStatistics(ArrayList<Voter> precinctVoters, ChangedPartyModel changeModel) {
